...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dojo Breogán — Club de Judo de Galicia" },
      { name: "description", content: "Club de Judo en Galicia. Formación, respeto y técnica para todas las edades." },
      { name: "author", content: "Dojo Breogán" },
      { property: "og:title", content: "Dojo Breogán — Club de Judo de Galicia" },
      { property: "og:description", content: "Club de Judo en Galicia. Formación, respeto y técnica para todas las edades." },
